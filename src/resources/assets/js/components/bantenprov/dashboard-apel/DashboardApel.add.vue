    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/dashboard-apel/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/dashboard-apel/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/dashboard-apel/create'
                  }
                },
                window.location.href = '#/admin/dashboard-apel/create')
        ...
        back() {
            window.location = '#/admin/dashboard-apel';
        }
    },
    mounted: function() {
        axios.get("/dashboard-apel/create").then(response => {
